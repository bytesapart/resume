...
% \hrule
\vspace{-1em}
\subsection*{\color{CarianBlue} \Large Experience \emph{(6 Years, 2 Months)} \crulefill{1pt}}
...
% ===== Begin CPP, IB Experience =====
        \item
              ...
              \begin{itemize*}
                ...
                \item \textbf{Technologies:} AWS, OneTick Timeseries, AWS DataSync, AWS Lambda, AWS EC2, AWS Aurora, AWS SNS, AWS SQS, AWS EFS, AWS Storage Gateway, C++ MFC, Python, pandas, numpy.
              \end{itemize*}
...
% ===== Nomura Associate Software Developer =====
              ...
              \begin{itemize*}
                ...
                \item {\textbf{Technologies:}} Python, pandas, numpy, C++, Boost, Clang, C\#, ASM, OpenMP, Intel Intrinsics, AVX2, Jenkins CI/CD, AWS, Docker, TDD.
              \end{itemize*}
...
\begin{itemize}[leftmargin=1em,noitemsep]
        ...
        \item Conducted a Tech Talk at Priceline on "Data Oriented Design".

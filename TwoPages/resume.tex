...
% ===== Begin CPP, IB Experience =====
        \item
              ...
              \begin{itemize*}
                ...
                \item \textbf{Technologies:} AWS, OneTick Timeseries, AWS DataSync, AWS Lambda, AWS EC2, AWS Aurora, AWS SNS, AWS SQS, AWS EFS, AWS Storage Gateway, C++ MFC, Python3, pandas-1.x, Numpy.
              \end{itemize*}
